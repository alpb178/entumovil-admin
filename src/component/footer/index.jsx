...
export default function FooterSite() {
  return (
    <footer className="relative ">
            ...
            <div className="m-10  bg-white">
              <div className="flex">
                ...
                <div className="m-8 w-1/2 ">
                  <p className="mb-6 text-xl">Contacto</p>
              ...
              <p className="text-black-600 content-left m-5 p-2  font-normal ">
                ...
                Biblioteca Nacional con el ISSN XXXX-XXXX. El presente trabajo
                ha sido realizado en el seno del proyecto INMOCOR (Ref.
                P20-00109).
              </p>
              <div className="flex">
                <div className="m-5 w-1/2  bg-white p-2">
      ...
      <div className=" bg-gradient-to-r from-gradient-for-footer to-gradient-to p-5 text-sm text-white">
        <div className="flex  px-8">
          <a className="w-1/2 m-2">
