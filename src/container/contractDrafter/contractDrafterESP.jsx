  ...
  return (
    <>
      ...
      <ContractDrafterComponent
        ...
        sumary="En XXX, a XXX de XXX de XXX"
        headersParts='Reunidos'
          parts="De un lado la parte vendedora, D XXX, mayor de edad, con
          ...
          clausesClient={[`PRIMERO: 
            ...
            headersClausesContract='Estipulaciones'
          clausesContract={[`PRIMERA.- Objeto D. XXX Y Dª. XXX, VENDEN la vivienda y anexos reseñados a D. XXX,
            ...
            Propietarios, así como del Reglamento de Régimen Interior.`, `OCTAVA.- Fuero. Las partes se someten a los Juzgados y Tribunales
