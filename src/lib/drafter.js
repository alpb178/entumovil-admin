  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        name: "opcion 2",
        value: [
          `Davant meu, JUAN MANUEL ÀLVAREZ-CIENFUEGOSSUÀREZ, Notari de l'Il.lustre Col.legi de Notaris de Catalunya amb residència a Terrassa.
        COMPAREIXEN
      ...
      },
      {
        ...
        name: "opcion 3",
        value: [
          `D’una banda, el senyor XXX, amb el DNI XXX, domiciliat alcarrer de XXX, 08950 Esplugues de Llobregat, com a part venedora.I de l’altra, la senyora XXX, amb el DNI XXX, domiciliada aXXX, 08760 Martorell, com a part compradora.
      ...
      },
      {
        ...
        name: "opcion 4",
        value: [
          `Els senyors Joan Rovira i Calvet, major d’edat, pagès, veí de Mollerussa, carrer de Joan Alcover, 6, i Silvestre Morera i Fígols, major d’edat, casat, professor mercantil, veí d’aquesta ciutat, plaça de la Paeria 1 9, primer pis,
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        name: "opcion 5",
        value: [
          `I, perquè consti, l’estenen 18 i el subscriuen 19 en dos exemplars de XXX folis cada un, de paper timbrat de classe XXX 1 
        `,
